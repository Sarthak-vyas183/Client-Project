...
function Nav() {
  return (
    <div className="w-full h-[10vh] backdrop-blur-sm fixed  text-[#e9e9e9]  flex items-center justify-between px-4 overflow-x-hidden z-10">

      <div className="w-[40%] h-full flex items-center gap-2 ">
        <img className="w-10 h-10 rounded-full " src={Logo} alt="Logo" />
        <h1 className="text-lg font-semibold">नवग्रह पूजा उज्जैन</h1>
      </div> 

      <section className="w-[60%] h-full pr-8  flex items-center justify-end">
